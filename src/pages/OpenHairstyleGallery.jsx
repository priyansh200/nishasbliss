...
const openHairstyleGallery = [
  {
    url: '/images/hairstyle/18.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/19.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/20.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/21.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/22.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/23.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/24.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/25.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
  {
    url: '/images/hairstyle/26.jpg',
    alt: 'Open Hairstyle',
    placeholder: false
  },
];
  ...
  return (
    <div className="py-16 bg-gradient-to-br from-salon-50 to-lavender-50">
      <div className="container-custom">
        ...
        >
          <h1 className="section-title">Open Hairstyle Gallery</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Explore our collection of stunning open hairstyles, from elegant waves to sleek straight looks.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {openHairstyleGallery.map((image, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
        ...
        >
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Ready for a New Look?</h2>
          <p className="text-gray-600 mb-6">
            Book your hairstyling appointment today and let us create your perfect style.
          </p>
          <motion.button
      ...
      <BookingModal
        ...
        service="Open Hairstyling"
      />
    </div>
  );
};

export default OpenHairstyleGallery; 