...
const bunsGallery = [
  {
    url: '/images/hairstyle/1.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/2.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/3.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/4.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/5.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/6.jpg',
    alt: 'Bun Style',
    placeholder: false
  },
  {
    url: '/images/hairstyle/7.jpg',
    alt: 'Bun Style',
    placeholder: false
  }
  ,{
    url: '/images/hairstyle/8.jpg',
    alt: 'Bun Style',
    placeholder: false
  }
];
  ...
  return (
    <div className="py-16 bg-gradient-to-br from-salon-50 to-lavender-50">
      <div className="container-custom">
        ...
        >
          <h1 className="section-title">Buns Gallery</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Discover our collection of elegant bun styles, perfect for any formal occasion or everyday sophistication.
          </p>
        </motion.div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {bunsGallery.map((image, index) => (
            <motion.div
              key={index}
              initial={{ opacity: 0, y: 20 }}
        ...
        >
          <h2 className="text-2xl font-bold text-gray-800 mb-4">Ready for Your Perfect Bun?</h2>
          <p className="text-gray-600 mb-6">
            Book your bun styling appointment today and achieve that perfect polished look.
          </p>
          <motion.button
