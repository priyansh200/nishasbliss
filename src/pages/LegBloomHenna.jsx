...
const legBloomGallery = [
  {
    url: '/images/mehndi/l1.jpg',
    alt: 'Intricate Leg Mehndi Design',
    placeholder: false
  },
  {
    url: '/images/mehndi/l2.jpg',
    alt: 'Floral Leg Pattern',
    placeholder: false
  },
  {
    url: '/images/mehndi/l3.jpg',
    alt: 'Modern Leg Henna',
    placeholder: false
  },
  {
    url: '/images/mehndi/l4.jpg',
    alt: 'Traditional Leg Design',
    placeholder: false
  },
  {
    url: '/images/mehndi/l5.jpg',
    alt: 'Traditional Leg Design',
    placeholder: false
  },{
    url: '/images/mehndi/l6.jpg',
    alt: 'Traditional Leg Design',
    placeholder: false
  },{
    url: '/images/mehndi/l7.jpg',
    alt: 'Traditional Leg Design',
    placeholder: false
  },
  ...
  return (
    <div className="py-16 bg-gradient-to-br from-salon-50 to-lavender-50">
      <div className="container-custom">
        ...
        >
          <h1 className="section-title">Leg Bloom Henna</h1>
          <p className="text-gray-600 max-w-2xl mx-auto mt-4">
            Discover our exquisite leg mehndi designs, perfect for brides and special occasions. 
            Each design is crafted to enhance the beauty of your feet and legs.
          </p>
        </motion.div>
          ...
          <div className="p-8">
            <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
              <div className="flex-1">
                <h2 className="text-2xl font-bold text-gray-800">Our Leg Henna Services</h2>
                <p className="text-gray-600 mt-2">
                  Experience the artistry of our skilled henna artists who specialize in creating stunning leg and feet designs.
                </p>
                
                {/* Features Grid */}
                <div className="grid md:grid-cols-3 gap-6 mt-6">
                  <div className="bg-gradient-to-br from-salon-50 to-lavender-50 p-4 rounded-xl">
                    <h3 className="text-lg font-semibold mb-2 text-gray-800">Custom Designs</h3>
                    <p className="text-gray-600 text-sm">
                      Personalized patterns tailored to your style and preferences.
                    </p>
                  </div>
                  <div className="bg-gradient-to-br from-salon-50 to-lavender-50 p-4 rounded-xl">
                    <h3 className="text-lg font-semibold mb-2 text-gray-800">Natural Ingredients</h3>
                    <p className="text-gray-600 text-sm">
                      100% natural henna for safe and long-lasting results.
                    </p>
                  </div>
                  <div className="bg-gradient-to-br from-salon-50 to-lavender-50 p-4 rounded-xl">
                    <h3 className="text-lg font-semibold mb-2 text-gray-800">Expert Application</h3>
                    <p className="text-gray-600 text-sm">
                      Skilled artists ensuring perfect application and stunning results.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {legBloomGallery.map((image, index) => (
                <motion.div
                  key={index}
                  initial={{ opacity: 0, y: 20 }}
                  whileInView={{ opacity: 1, y: 0 }}
      ...
      <BookingModal
        ...
        service="Leg Bloom Henna"
      />
    </div>
  );
};

export default LegBloomHenna; 